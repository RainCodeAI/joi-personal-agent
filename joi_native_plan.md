...
- Phase E tray camera controls on 2026-07-01 add native-shell camera active reporting plus tray camera enabled/active/suspended status and suspend/resume actions backed by the perception policy. Packaged WebView2 hands-on validation remains.
