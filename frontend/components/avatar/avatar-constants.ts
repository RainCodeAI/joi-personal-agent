...
export const VRM_VISIBLE_LOOK_AT = new THREE.Vector3(0, 1.5, 0);
export const GLB_VISIBLE_LOOK_AT = new THREE.Vector3(0, 1.48, 0);
export const VRM_CAMERA_POSITION = new THREE.Vector3(0, 1.8, 6.18);
...
export const VRM_COMPACT_VISIBLE_LOOK_AT = new THREE.Vector3(0, 1.4, 0);
export const GLB_COMPACT_VISIBLE_LOOK_AT = new THREE.Vector3(0, 1.76, 0);
export const VRM_COMPACT_CAMERA_POSITION = new THREE.Vector3(0, 1.7, 5.35);
